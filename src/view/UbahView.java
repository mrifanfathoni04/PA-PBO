...
public class UbahView extends javax.swing.JFrame {
    ...
    public static UbahView getInstance() {
        return new UbahView();
    }
    ...
    private void txtHargaKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtHargaKeyTyped
        ...
        boolean max = txtHarga.getText().length() > 5;
        if (max) {
            evt.consume();
        }
    ...
    private void txtWarnaKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtWarnaKeyTyped
        // TODO add your handling code here:
        boolean max = txtWarna.getText().length() > 40;
        if (max) {
            evt.consume();
        }
    }//GEN-LAST:event_txtWarnaKeyTyped
    public void data() {
        List<String> data = Pakaian.getDataPakaianUbah(Pakaian.idUbahData);
        lblId.setText(data.get(0));
        lblJenis.setText(data.get(1));
        lblModel.setText(data.get(2));
        lblDesain.setText(data.get(3));
        lblBahan.setText(data.get(4));
        lblWarna.setText(data.get(5));
        lblUkuran.setText(data.get(6));
        lblHarga.setText(data.get(7));
