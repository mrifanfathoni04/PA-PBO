...
public class RegistrasiView extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        txtNamar.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyTyped(java.awt.event.KeyEvent evt) {
                txtNamarKeyTyped(evt);
            }
        });
    ...
    private void txtNamarKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtNamarKeyTyped
        // TODO add your handling code here:
                boolean max = txtNamar.getText().length() > 50;
        if (max) {
            evt.consume();}
    }//GEN-LAST:event_txtNamarKeyTyped

    private void txtPasswordrKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtPasswordrKeyTyped
        // TODO add your handling code here:
                boolean max = txtPasswordr.getText().length() > 50;
        if (max) {
            evt.consume();}
