 ...
 */
public class PakaianFavoritView extends javax.swing.JFrame {

    /**
     * Creates new form PakaianFavoritView
     */
    public PakaianFavoritView() {
        initComponents();
        TableData();
    }
    public static PakaianFavoritView getInstance() {
        return new PakaianFavoritView();
    }
    /**
    ...
    private void initComponents() {
        ...
        jLabel31.setText("MENU CUSTOMER - PAKAIAN FAVORIT");
        ...
        btnHapus.setFont(new java.awt.Font("Buxton Sketch", 0, 36)); // NOI18N
        btnHapus.setForeground(new java.awt.Color(255, 204, 102));
        btnHapus.setText("Hapus dari Favorit");
        btnHapus.setActionCommand("History Pembelian");
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGap(36, 36, 36)
                        .addComponent(jLabel31, javax.swing.GroupLayout.PREFERRED_SIZE, 728, javax.swing.GroupLayout.PREFERRED_SIZE)))
    ...
    private void TableData() {
        ...
        List<List<String>> data = PakaianController.getDataFavorit(UserSession.getInstance().getUserName());
    ...
    private void btnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnHapusActionPerformed
        ...
        if (row >= 0) {
            DefaultTableModel model = (DefaultTableModel) tabelPakaian.getModel();
            String id = model.getValueAt(row, 0).toString();
            int response = JOptionPane.showConfirmDialog(null, "Apakah Anda Ingin Menghapus data Pakaian id " + id + " dari Pakaian Favorit?", "Konfirmasi", JOptionPane.YES_NO_OPTION);
            if (response == JOptionPane.YES_OPTION) {
                PakaianFavorit.HapusFavorit(id, UserSession.getInstance().getUserName());
                TableData();
                JOptionPane.showMessageDialog(null, "Hapus Pakaian ke Favorit berhasil");
            } else {
                JOptionPane.showMessageDialog(null, "Hapus Pakaian ke Favorit dibatalkan");
            }
            TableData();
        } else {
            JOptionPane.showMessageDialog(null, "Tidak ada baris pada tabel yang dipilih! ");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PakaianFavoritView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
