...
public class HistoryPembelianCustomer extends javax.swing.JFrame {
    ...
    public static HistoryPembelianCustomer getInstance() {
        return new HistoryPembelianCustomer();
    }
    ...
    private void TableData() {
        ...
        List<List<String>> data = Pakaian.getDataPakaianHistoryCustomer(UserSession.getInstance().getUserName());
